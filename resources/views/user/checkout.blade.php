        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input type="text" id="your_name" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="Your name" required />
            </div>

            <div>
              <label for="email" class="mb-2 block text-sm font-medium text-gray-900"> Email </label>
              <input type="email" id="email" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="name@gmail.com" required />
            </div>

            <div>
              <label for="email" class="mb-2 block text-sm font-medium text-gray-900"> Address </label>
              <input type="email" id="email" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="Your address" required />
            </div>
            ...
            <div>
              ...
              <select id="region" onchange="fetch_provinces()" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500">
            ...
            <div>
              ...
              <select id="province" onchange="fetch_cities()" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500">
            ...
            <div>
              ...
              <select id="city" onchange="fetch_barangays()" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500">
            ...
            <div>
              <div class="mb-2 flex items-center gap-2">
              <label for="barangay" class="block text-sm font-medium text-gray-900"> Baranggay </label>
              </div>
              <select id="barangay" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500">
            ...
            <div>
              ...
              <select id="phoneno" class="w-28 text-start rounded-s-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-200 focus:outline-none focus:ring-4 focus:ring-gray-100" onchange="updatePhoneCode()">
